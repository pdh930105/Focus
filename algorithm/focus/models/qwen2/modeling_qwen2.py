...
def Qwen2DecoderLayer_focus_forward(
    self,
...
def Qwen2SdpaAttention_focus_forward(
    self,
    hidden_states: torch.Tensor,
    ...
    **kwargs,
    ...
    if (self.layer_idx in self.focus.selected_layer and seq_len > 1) or (self.layer_idx in self.focus.extract_attention_layer and seq_len > 1):
...
def Qwen2MLP_focus_forward(self, x):
